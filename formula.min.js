...
class Formula {
  ...
  _buildFields(wrapper, fields, path = '', prefix) {
    ...
    wrapper.appendChild(ul); // For each property
    ...
    Object.entries(fields).forEach(([field, {
      ...
      if (children) {
        ...
        fieldLi.appendChild(fieldChevron); // Field children LI
  ...
  _listenToFieldChevronClick(chevron, customData) {
    chevron.addEventListener('click', e => {
      ...
      if (chevron.parentElement.classList.contains('open')) {
        chevron.parentElement.classList.remove('open'); // Close children trees too
  ...
  _listen() {
    ...
    this._input.addEventListener('click', e => {
      this._input.classList.add('active'); // Tag click
    ...
    document.addEventListener('click', e => {
      const closestFormulaInput = e.target.closest('.formula-js-input'); // Clicked inside a FormulaJS input
    ...
    if (this._options.customFields) {
      this._container.querySelector('.field-button').addEventListener('click', e => {
        ...
        if (e.target.classList.contains('active')) {
          ...
          this._container.querySelector('.formula-js-fields').classList.remove('formula-js-field-open'); // Close all open fields
  ...
  add(formulaString) {
    // Set the caret
    this._caret.textContent += formulaString; // Process the string
